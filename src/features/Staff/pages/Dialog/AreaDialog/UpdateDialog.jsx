...
function UpdateDialog({
  ...
  function filterCageNoArea() {
    const filterdDate = cageData.filter((cage) => cage.area === null);
      ...
      if (id) {
        ...
        if (confirmed) {
          ...
          if (response.ok) {
            ...
            fetchAreaDetail(formData.idArea);
            handleCloseUpdateDialog();
            fetchCages();
          } else {
            // Xử lý lỗi nếu cần
